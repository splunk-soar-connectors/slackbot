...
class GetActionCommand(Command):
    ...
    def configure_parser(self, parser) -> None:
        ...
        verbosity_group.add_argument(
            "-s", "--short", default=False, action="store_true", help="If specified, prints the output in a compact format"
        )
        verbosity_group.add_argument(
            "-v", "--verbose", default=False, action="store_true", help="If specified, prints extra information about actions"
        )
