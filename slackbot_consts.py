...
SLACK_SUCCESS_MESSAGE = "Slack message post successful"
...
SLACK_ERROR_CODE_UNAVAILABLE = "Error code unavailable"
SLACK_ERROR_MESSAGE_UNKNOWN = "Unknown error occurred. Please check the asset configuration and|or action parameters"
...
SLACK_ERROR_TEST_CONNECTION_FAILED = "Test Connectivity Failed"
SLACK_SUCCESS_TEST_CONNECTION_PASSED = "Test Connectivity Passed"
...
SLACK_SUCCESS_CHANNEL_CREATED = "Channel created successfully"
...
SLACK_SUCCESS_USER_DATA_RETRIEVED = "User data successfully retrieved"
...
SLACK_SUCCESS_INVITE_SENT = "Invite sent to user(s)"
...
SLACK_SUCCESS_MESSAGE_SENT = "Message sent successfully"
SLACK_SUCCESS_REACTION_ADDED = "Reaction added successfully"
SLACK_ERROR_FILE_OR_CONTENT_NOT_PROVIDED = "Please provide either a 'file' or 'content' to upload"
SLACK_SUCCESS_FILE_UPLOAD = "File uploaded successfully"
SLACK_SUCCESS_SLACKBOT_STOPPED = "SlackBot has been stopped."
...
SLACK_SUCCESS_SLACKBOT_RUNNING = "SlackBot already running"
...
SLACK_SUCCESS_SLACKBOT_STARTED = "SlackBot started"
SLACK_ERROR_UNABLE_TO_SEND_QUESTION_TO_CHANNEL = "Questions may only be sent as direct messages to users. They may not be sent to channels."
