...
SLACK_BOT_ERROR_SLACK_BOT_RUNNING_WITH_SAME_BOT_TOKEN = ('Detected an instance of Slack Bot running with the same bot token. '
                                                       'Not going to start new instance.')
SLACK_BOT_ERROR_OLD_SLACK_BOT_VERSION_RUNNING = ('Detected a different version of Slack Bot already running. '
                                               'Not going to start new instance.')
